...
class PW_CMB2_Field_Select2 {
	...
	public function __construct() {
		add_filter( 'cmb2_render_select2', array( $this, 'render_pw_select' ), 10, 5 );
		add_filter( 'cmb2_render_multiselect2', array( $this, 'render_pw_multiselect' ), 10, 5 );
		add_filter( 'cmb2_sanitize_multiselect2', array( $this, 'pw_multiselect_sanitize' ), 10, 4 );
		add_filter( 'cmb2_types_esc_multiselect2', array( $this, 'pw_multiselect_escaped_value' ), 10, 3 );
